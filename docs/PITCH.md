...
| **Build quality** | does it run, is it structured, would you trust it | one command, no Docker, 1,149 tests, `mypy --strict` |
...
| **Failure recovery** | what broke, and what you did about it | 38 written incidents, each with the reason no test caught it |
...
> none was reachable from local testing at any volume. The suite is at 1,149 tests and I trust it
