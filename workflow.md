...
| **12b** | Command Center | `apps/web/**` | All ten §19.2 components render against the 12a contract; types generated from the committed OpenAPI schema so the contract cannot drift silently; Razorpay-native palette; every rupee figure renders its provenance badge |
